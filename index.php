    ...
    <div class="navbar-collapse collapse in">
      ...
      <ul class="nav navbar-nav navbar-right">
    	...
    	if (!isset($_SESSION['steamid'])) { 
    		echo "<a href=\"/html/pages/profile.html\" class=\"dropdown-toggle\"  data-toggle=\"dropdown\">";
  			echo 	"<img class=\"profile-img\" src=" . $userInfo['profile_pic_url'] . ">";
  			echo 	"<div class=\"title\">Profile</div>";
			echo "</a>";
			...
			if ($loggedInUser->registered()) {
				require "elements/profiledropdown.php";
			}
		}
